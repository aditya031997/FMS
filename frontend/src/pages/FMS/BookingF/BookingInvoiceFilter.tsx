...
const BookingInvoiceFilter = () => {
    ...
    console.log(filterInvoice, "bsfmbdnfb")
                                ...
                                {(isLoading ? filterInvoice : filteredItems).length > 0 ? (
                                    (isLoading ? filterInvoice : filteredItems).map((contact: any, index: any) => (
                                        <tr key={contact.id}>
                                            ...
                                            <td className="whitespace-nowrap">{contact?.updatedAt}</td>
                                            <td className="whitespace-nowrap">{contact?.invoice_id}</td>
                                            ...
                                            <td className="whitespace-nowrap">{contact?.totalAmount}</td>
